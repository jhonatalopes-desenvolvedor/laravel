...
class VueAnalyzer
{
    ...
    public function __construct()
    {
        ...
        $this->scriptPath = base_path('resources/js/Mcp/VueAnalyzer.js');
    }
    ...
    public function analyzeBatch(array $filePaths): array
    {
        ...
        try {
            ...
            if (json_last_error() !== JSON_ERROR_NONE) {
                return array_fill_keys($filePaths, ['status' => 'error', 'message' => 'Failed to decode JSON from Node.js batch script.']);
            }
